...
class FacetecStrings {
    static let spanish: [String: String] = [
        ...
        "FaceTec_instructions_header_ready_2": "Prepárate para la selfie",
        "FaceTec_instructions_message_ready_1": "Alinea tu rostro dentro del óvalo",
        "FaceTec_instructions_message_ready_2": "",

        // Retry
        "FaceTec_retry_header": "Intentémoslo otra vez",
        "FaceTec_retry_subheader_message": "Necesitamos una selfie más nítida",
        ...
        "FaceTec_idscan_capture_id_front_instruction_message": "Frente de tu cédula",
        "FaceTec_idscan_capture_id_back_instruction_message": "Reverso de tu cédula",
        ...
        "FaceTec_idscan_nfc_card_status_starting_message": "Acerca el teléfono a tu cédula\npara escanear el chip NFC",
        ...
        "FaceTec_result_facescan_upload_message": "Analizando tu selfie",
        "FaceTec_result_idscan_upload_message": "Analizando la imagen de la\ncédula",
        "FaceTec_result_nfc_upload_message": "Analizando la información NFC",
        "FaceTec_result_idscan_unsuccess_message": "La foto de la cédula\nno coincide con el rostro del usuario",
        "FaceTec_result_idscan_success_front_side_message": "Escaneo de cédula completado",
        "FaceTec_result_idscan_success_front_side_back_next_message": "Lado frontal de la cédula\nescaneado",
        "FaceTec_result_idscan_success_front_side_nfc_next_message": "Frente de la cédula\nescaneado",
        "FaceTec_result_idscan_success_back_side_message": "Escaneo de cédula completado",
        "FaceTec_result_idscan_success_back_side_nfc_next_message": "Reverso de la cédula\nescaneado",
        ...
        "FaceTec_result_idscan_success_user_confirmation_message": "Escaneo de la cédula con fotografía\ncompletado",
        "FaceTec_result_idscan_success_nfc_message": "Escaneo de cédula completado",
        "FaceTec_result_idscan_success_additional_review_message": "Captura de la fotografía de la cédula\ncompletada",
        "FaceTec_result_idscan_skip_or_error_nfc_message": "Información de la cédula\nsubida",
        "FaceTec_result_idscan_retry_face_did_not_match_message": "El rostro no coincide\nlo suficiente",
        "FaceTec_result_idscan_retry_id_not_fully_visible_message": "La cédula\nno es totalmente visible",
        "FaceTec_result_idscan_retry_ocr_results_not_good_enough_message": "El texto de la cédula no es legible",
